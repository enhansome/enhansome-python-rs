...
* [opendal](https://github.com/apache/opendal) ⭐ 5,328 | 🐛 325 | 🌐 Rust | 📅 2026-08-21 - Apache OpenDAL: unified data access layer for all storage services.
* [obstore](https://github.com/developmentseed/obstore) ⭐ 801 | 🐛 56 | 🌐 Python | 📅 2026-08-20 - High-throughput Python interface to S3, GCS, and Azure Storage.

## Cryptography & Hashing

* [cryptography](https://github.com/pyca/cryptography) ⭐ 7,713 | 🐛 35 | 🌐 Python | 📅 2026-08-20 - The standard Python cryptographic library, with performance-critical parts in Rust.
...
* [pathway](https://github.com/pathwaycom/pathway) ⭐ 62,409 | 🐛 35 | 🌐 Python | 📅 2026-08-21 - Performant Python ETL framework with a Rust runtime.
* [polars](https://github.com/pola-rs/polars) ⭐ 39,421 | 🐛 2,857 | 🌐 Rust | 📅 2026-08-20 - DataFrame library with lazy evaluation and parallel execution.
* [sail](https://github.com/lakehq/sail) ⭐ 3,323 | 🐛 258 | 🌐 Rust | 📅 2026-08-21 - Unifying stream, batch, and AI workloads with Apache Spark compatibility.
* [delta-rs](https://github.com/delta-io/delta-rs) ⭐ 3,284 | 🐛 211 | 🌐 Rust | 📅 2026-08-20 - Native Rust library for Delta Lake with Python bindings (`deltalake` on PyPI).
* [connector-x](https://github.com/sfu-db/connector-x) ⭐ 2,644 | 🐛 234 | 🌐 Rust | 📅 2026-08-17 - Fastest library to load data from databases into DataFrames.
...
* [whenever](https://github.com/ariebovenberg/whenever) ⭐ 2,389 | 🐛 8 | 🌐 Python | 📅 2026-08-18 - Typed and DST-safe datetimes for Python.
...
* [pyochain](https://github.com/OutSquareCapital/pyochain) ⭐ 66 | 🐛 15 | 🌐 Python | 📅 2026-08-20 - Iterator, sorted containers, Result, Option, ABCs and more, written in Rust, for Python.
...
* [cramjam](https://github.com/milesgranger/cramjam) ⭐ 125 | 🐛 14 | 🌐 Rust | 📅 2026-08-20 - Thin Python bindings to de/compression algorithms (snappy, brotli, lz4, zstd, etc.).
...
* [utiles](https://github.com/jessekrubin/utiles) ⭐ 28 | 🐛 8 | 🌐 Rust | 📅 2026-08-20 - Fast web-map tile utilities.

## Graph Libraries

* [rustworkx](https://github.com/Qiskit/rustworkx) ⭐ 1,743 | 🐛 135 | 🌐 Rust | 📅 2026-08-17 - A high-performance Python graph library (originally created for Qiskit).

## HTTP Clients

* [rnet](https://github.com/0x676e67/rnet) ⭐ 1,429 | 🐛 8 | 🌐 Rust | 📅 2026-08-17 - Asynchronous Python HTTP client powered by Rust.
...
* [ruff](https://github.com/astral-sh/ruff) ⭐ 49,272 | 🐛 2,130 | 🌐 Rust | 📅 2026-08-21 - An extremely fast Python linter and code formatter.
* [ty](https://github.com/astral-sh/ty) ⭐ 19,518 | 🐛 887 | 🌐 Python | 📅 2026-08-20 - An extremely fast Python type checker and language server by Astral.
* [pyrefly](https://github.com/facebook/pyrefly) ⭐ 6,900 | 🐛 683 | 🌐 Rust | 📅 2026-08-21 - A fast Python type checker and language server from Meta.
...
* [rumdl](https://github.com/rvben/rumdl) ⭐ 1,441 | 🐛 10 | 🌐 Rust | 📅 2026-08-19 - A high-performance Markdown linter and formatter written in Rust.
* [zuban](https://github.com/zubanls/zuban) ⭐ 1,166 | 🐛 92 | 🌐 Rust | 📅 2026-08-18 - A high-performance Python language server and type checker with PyRight-like and Mypy-compatible modes.

## Miscellaneous

* [pyxel](https://github.com/kitao/pyxel) ⭐ 17,669 | 🐛 9 | 🌐 Rust | 📅 2026-08-12 - A retro game engine for Python, with core written in Rust.
...
* [ry](https://github.com/jessekrubin/ry) ⭐ 75 | 🐛 15 | 🌐 Rust | 📅 2026-08-20 - Collection of Python bindings to Rust crates providing utilities for async HTTP, datetime, file I/O, and compression.

## Package Management & Tooling

* [uv](https://github.com/astral-sh/uv) ⭐ 88,925 | 🐛 2,845 | 🌐 Rust | 📅 2026-08-21 - An extremely fast Python package and project manager. 10-100x faster than pip, replaces pip-tools, poetry, pyenv, pipx, and virtualenv in a single tool.
* [prek](https://github.com/j178/prek) ⭐ 8,288 | 🐛 36 | 🌐 Rust | 📅 2026-08-21 - A fast Rust-based reimplementation of the pre-commit framework for managing Git hooks.
* [pixi](https://github.com/prefix-dev/pixi) ⭐ 7,611 | 🐛 651 | 🌐 Rust | 📅 2026-08-21 - A fast conda/pip package manager.
* [maturin](https://github.com/PyO3/maturin) ⭐ 5,765 | 🐛 53 | 🌐 Rust | 📅 2026-08-17 - Build and publish Rust-based Python packages with pyo3, cffi, and uniffi bindings.
...
* [RustPython](https://github.com/RustPython/RustPython) ⭐ 22,293 | 🐛 410 | 🌐 Rust | 📅 2026-08-21 - A Python 3 interpreter written entirely in Rust.
* [PyO3](https://github.com/PyO3/pyo3) ⭐ 16,055 | 🐛 389 | 🌐 Rust | 📅 2026-08-20 - Rust bindings for the Python interpreter. The foundation for most projects on this list.
* [setuptools-rust](https://github.com/PyO3/setuptools-rust) ⭐ 677 | 🐛 16 | 🌐 Python | 📅 2026-08-12 - Setuptools plugin for Rust extensions.

## Scientific Computing

* [river](https://github.com/online-ml/river) ⭐ 5,920 | 🐛 70 | 🌐 Python | 📅 2026-08-20 - Online machine learning in Python; computationally heavy algorithms in Rust.
...
* [orjson](https://github.com/ijl/orjson) ⭐ 8,208 | 🐛 0 | 🌐 Python | 📅 2026-08-20 - Fast, correct JSON library supporting dataclasses, datetimes, and numpy.
* [jiter](https://github.com/pydantic/jiter) ⭐ 541 | 🐛 28 | 🌐 Rust | 📅 2026-08-20 - Fast iterable JSON parser, used by pydantic and the OpenAI Python SDK.
...
* [tiktoken](https://github.com/openai/tiktoken) ⭐ 19,056 | 🐛 128 | 🌐 Python | 📅 2026-08-17 - A fast BPE tokenizer for use with OpenAI's models.
* [tokenizers](https://github.com/huggingface/tokenizers) ⭐ 10,983 | 🐛 266 | 🌐 Rust | 📅 2026-08-21 - Hugging Face's fast tokenizer library with Python bindings.
* [safetensors](https://github.com/huggingface/safetensors) ⭐ 3,861 | 🐛 72 | 🌐 Rust | 📅 2026-08-18 - A safe and fast format for storing and loading tensors.
...
* [jsonschema-rs](https://github.com/Stranger6667/jsonschema) ⭐ 805 | 🐛 14 | 🌐 Rust | 📅 2026-08-21 - A high-performance JSON Schema validator.

## Visualization

* [rerun](https://github.com/rerun-io/rerun) ⭐ 11,332 | 🐛 1,271 | 🌐 Rust | 📅 2026-08-20 - Visualize streams of multimodal data. Built in Rust with a Python SDK.

## Web Frameworks & Servers

* [robyn](https://github.com/sansyrox/robyn) ⭐ 7,373 | 🐛 96 | 🌐 Python | 📅 2026-08-17 - A super fast async Python web framework with a Rust runtime.
