...
* [satkit](https://github.com/ssmichael1/satkit) ⭐ 90 | 🐛 10 | 🌐 Rust | 📅 2026-09-20 - Satellite and orbital mechanics toolkit for astrodynamics calculations including orbit propagation and coordinate transformations.
...
* [opendal](https://github.com/apache/opendal) ⭐ 5,388 | 🐛 333 | 🌐 Rust | 📅 2026-09-21 - Apache OpenDAL: unified data access layer for all storage services.
* [obstore](https://github.com/developmentseed/obstore) ⭐ 813 | 🐛 56 | 🌐 Python | 📅 2026-09-15 - High-throughput Python interface to S3, GCS, and Azure Storage.

## Cryptography & Hashing

* [cryptography](https://github.com/pyca/cryptography) ⭐ 7,778 | 🐛 36 | 🌐 Python | 📅 2026-09-21 - The standard Python cryptographic library, with performance-critical parts in Rust.
...
* [pathway](https://github.com/pathwaycom/pathway) ⭐ 62,254 | 🐛 37 | 🌐 Python | 📅 2026-09-21 - Performant Python ETL framework with a Rust runtime.
* [polars](https://github.com/pola-rs/polars) ⭐ 39,822 | 🐛 2,899 | 🌐 Rust | 📅 2026-09-21 - DataFrame library with lazy evaluation and parallel execution.
* [sail](https://github.com/lakehq/sail) ⭐ 3,382 | 🐛 280 | 🌐 Rust | 📅 2026-09-21 - Unifying stream, batch, and AI workloads with Apache Spark compatibility.
* [delta-rs](https://github.com/delta-io/delta-rs) ⭐ 3,315 | 🐛 164 | 🌐 Rust | 📅 2026-09-21 - Native Rust library for Delta Lake with Python bindings (`deltalake` on PyPI).
* [connector-x](https://github.com/sfu-db/connector-x) ⭐ 2,648 | 🐛 215 | 🌐 Rust | 📅 2026-09-20 - Fastest library to load data from databases into DataFrames.
* [datafusion-python](https://github.com/apache/datafusion-python) ⭐ 605 | 🐛 103 | 🌐 Python | 📅 2026-09-20 - Python bindings for Apache DataFusion, an in-memory query engine.
* [hudi-rs](https://github.com/apache/hudi-rs) ⭐ 279 | 🐛 85 | 🌐 Rust | 📅 2026-09-18 - Native Rust implementation for Apache Hudi with Python bindings.
...
* [pyochain](https://github.com/OutSquareCapital/pyochain) ⭐ 73 | 🐛 15 | 🌐 Python | 📅 2026-09-21 - Iterator, sorted containers, Result, Option, ABCs and more, written in Rust, for Python.
...
* [watchfiles](https://github.com/samuelcolvin/watchfiles) ⭐ 2,538 | 🐛 45 | 🌐 Python | 📅 2026-09-21 - Simple, modern, fast file watching and code reload, powered by Rust's `notify` crate.
...
* [rnet](https://github.com/0x676e67/rnet) ⭐ 1,447 | 🐛 12 | 🌐 Rust | 📅 2026-09-18 - Asynchronous Python HTTP client powered by Rust.
...
* [ruff](https://github.com/astral-sh/ruff) ⭐ 49,719 | 🐛 2,196 | 🌐 Rust | 📅 2026-09-21 - An extremely fast Python linter and code formatter.
* [ty](https://github.com/astral-sh/ty) ⭐ 19,729 | 🐛 917 | 🌐 Python | 📅 2026-09-18 - An extremely fast Python type checker and language server by Astral.
* [pyrefly](https://github.com/facebook/pyrefly) ⭐ 6,993 | 🐛 715 | 🌐 Rust | 📅 2026-09-21 - A fast Python type checker and language server from Meta.
...
* [rumdl](https://github.com/rvben/rumdl) ⭐ 1,511 | 🐛 26 | 🌐 Rust | 📅 2026-09-21 - A high-performance Markdown linter and formatter written in Rust.
...
* [pyxel](https://github.com/kitao/pyxel) ⭐ 17,876 | 🐛 10 | 🌐 Rust | 📅 2026-09-16 - A retro game engine for Python, with core written in Rust.
* [pycrdt](https://github.com/jupyter-server/pycrdt) ⭐ 205 | 🐛 27 | 🌐 Python | 📅 2026-09-21 - Python bindings for the Yrs Rust CRDT implementation (collaborative editing).
...
* [uv](https://github.com/astral-sh/uv) ⭐ 90,030 | 🐛 2,915 | 🌐 Rust | 📅 2026-09-21 - An extremely fast Python package and project manager. 10-100x faster than pip, replaces pip-tools, poetry, pyenv, pipx, and virtualenv in a single tool.
* [prek](https://github.com/j178/prek) ⭐ 8,438 | 🐛 36 | 🌐 Rust | 📅 2026-09-21 - A fast Rust-based reimplementation of the pre-commit framework for managing Git hooks.
* [pixi](https://github.com/prefix-dev/pixi) ⭐ 7,758 | 🐛 719 | 🌐 Rust | 📅 2026-09-21 - A fast conda/pip package manager.
* [maturin](https://github.com/PyO3/maturin) ⭐ 5,813 | 🐛 56 | 🌐 Rust | 📅 2026-09-21 - Build and publish Rust-based Python packages with pyo3, cffi, and uniffi bindings.
...
* [RustPython](https://github.com/RustPython/RustPython) ⭐ 22,355 | 🐛 394 | 🌐 Rust | 📅 2026-09-21 - A Python 3 interpreter written entirely in Rust.
* [PyO3](https://github.com/PyO3/pyo3) ⭐ 16,158 | 🐛 407 | 🌐 Rust | 📅 2026-09-19 - Rust bindings for the Python interpreter. The foundation for most projects on this list.
* [setuptools-rust](https://github.com/PyO3/setuptools-rust) ⭐ 680 | 🐛 19 | 🌐 Python | 📅 2026-09-10 - Setuptools plugin for Rust extensions.

## Scientific Computing

* [river](https://github.com/online-ml/river) ⭐ 6,105 | 🐛 70 | 🌐 Python | 📅 2026-09-21 - Online machine learning in Python; computationally heavy algorithms in Rust.
...
* [tiktoken](https://github.com/openai/tiktoken) ⭐ 19,297 | 🐛 132 | 🌐 Python | 📅 2026-08-17 - A fast BPE tokenizer for use with OpenAI's models.
* [tokenizers](https://github.com/huggingface/tokenizers) ⭐ 11,052 | 🐛 208 | 🌐 Rust | 📅 2026-09-21 - Hugging Face's fast tokenizer library with Python bindings.
* [safetensors](https://github.com/huggingface/safetensors) ⭐ 3,900 | 🐛 92 | 🌐 Rust | 📅 2026-09-21 - A safe and fast format for storing and loading tensors.
...
* [jsonschema-rs](https://github.com/Stranger6667/jsonschema) ⭐ 817 | 🐛 19 | 🌐 Rust | 📅 2026-09-21 - A high-performance JSON Schema validator.

## Visualization

* [rerun](https://github.com/rerun-io/rerun) ⭐ 11,482 | 🐛 1,270 | 🌐 Rust | 📅 2026-09-21 - Visualize streams of multimodal data. Built in Rust with a Python SDK.

## Web Frameworks & Servers

* [robyn](https://github.com/sansyrox/robyn) ⭐ 7,405 | 🐛 102 | 🌐 Python | 📅 2026-09-14 - A super fast async Python web framework with a Rust runtime.
* [granian](https://github.com/emmett-framework/granian) ⭐ 5,657 | 🐛 42 | 🌐 Rust | 📅 2026-09-14 - A Rust HTTP server for Python WSGI/ASGI/RSGI apps, built on Hyper and Tokio.

## Web Scraping & HTML

* [selectolax](https://github.com/rushter/selectolax) ⭐ 1,678 | 🐛 9 | 🌐 Cython | 📅 2026-09-18 - Fast HTML5 parser with CSS selectors, using Rust's html5ever engine.
