...
* [opendal](https://github.com/apache/opendal) ⭐ 5,329 | 🐛 325 | 🌐 Rust | 📅 2026-08-22 - Apache OpenDAL: unified data access layer for all storage services.
...
* [cryptography](https://github.com/pyca/cryptography) ⭐ 7,717 | 🐛 36 | 🌐 Python | 📅 2026-08-22 - The standard Python cryptographic library, with performance-critical parts in Rust.
...
* [pathway](https://github.com/pathwaycom/pathway) ⭐ 62,400 | 🐛 35 | 🌐 Python | 📅 2026-08-23 - Performant Python ETL framework with a Rust runtime.
* [polars](https://github.com/pola-rs/polars) ⭐ 39,447 | 🐛 2,856 | 🌐 Rust | 📅 2026-08-23 - DataFrame library with lazy evaluation and parallel execution.
* [sail](https://github.com/lakehq/sail) ⭐ 3,323 | 🐛 256 | 🌐 Rust | 📅 2026-08-23 - Unifying stream, batch, and AI workloads with Apache Spark compatibility.
* [delta-rs](https://github.com/delta-io/delta-rs) ⭐ 3,284 | 🐛 211 | 🌐 Rust | 📅 2026-08-22 - Native Rust library for Delta Lake with Python bindings (`deltalake` on PyPI).
...
* [datafusion-python](https://github.com/apache/datafusion-python) ⭐ 597 | 🐛 92 | 🌐 Python | 📅 2026-08-22 - Python bindings for Apache DataFusion, an in-memory query engine.
...
* [whenever](https://github.com/ariebovenberg/whenever) ⭐ 2,393 | 🐛 7 | 🌐 Python | 📅 2026-08-22 - Typed and DST-safe datetimes for Python.
...
* [pyochain](https://github.com/OutSquareCapital/pyochain) ⭐ 67 | 🐛 16 | 🌐 Python | 📅 2026-08-22 - Iterator, sorted containers, Result, Option, ABCs and more, written in Rust, for Python.
...
* [utiles](https://github.com/jessekrubin/utiles) ⭐ 29 | 🐛 4 | 🌐 Rust | 📅 2026-08-22 - Fast web-map tile utilities.

## Graph Libraries

* [rustworkx](https://github.com/Qiskit/rustworkx) ⭐ 1,745 | 🐛 135 | 🌐 Rust | 📅 2026-08-17 - A high-performance Python graph library (originally created for Qiskit).
...
* [ruff](https://github.com/astral-sh/ruff) ⭐ 49,279 | 🐛 2,141 | 🌐 Rust | 📅 2026-08-22 - An extremely fast Python linter and code formatter.
* [ty](https://github.com/astral-sh/ty) ⭐ 19,534 | 🐛 892 | 🌐 Python | 📅 2026-08-22 - An extremely fast Python type checker and language server by Astral.
* [pyrefly](https://github.com/facebook/pyrefly) ⭐ 6,902 | 🐛 676 | 🌐 Rust | 📅 2026-08-22 - A fast Python type checker and language server from Meta.
...
* [rumdl](https://github.com/rvben/rumdl) ⭐ 1,444 | 🐛 6 | 🌐 Rust | 📅 2026-08-22 - A high-performance Markdown linter and formatter written in Rust.
...
* [pyxel](https://github.com/kitao/pyxel) ⭐ 17,756 | 🐛 9 | 🌐 Rust | 📅 2026-08-12 - A retro game engine for Python, with core written in Rust.
...
* [ry](https://github.com/jessekrubin/ry) ⭐ 75 | 🐛 10 | 🌐 Rust | 📅 2026-08-22 - Collection of Python bindings to Rust crates providing utilities for async HTTP, datetime, file I/O, and compression.

## Package Management & Tooling

* [uv](https://github.com/astral-sh/uv) ⭐ 88,986 | 🐛 2,853 | 🌐 Rust | 📅 2026-08-22 - An extremely fast Python package and project manager. 10-100x faster than pip, replaces pip-tools, poetry, pyenv, pipx, and virtualenv in a single tool.
* [prek](https://github.com/j178/prek) ⭐ 8,301 | 🐛 37 | 🌐 Rust | 📅 2026-08-21 - A fast Rust-based reimplementation of the pre-commit framework for managing Git hooks.
* [pixi](https://github.com/prefix-dev/pixi) ⭐ 7,620 | 🐛 650 | 🌐 Rust | 📅 2026-08-22 - A fast conda/pip package manager.
* [maturin](https://github.com/PyO3/maturin) ⭐ 5,769 | 🐛 54 | 🌐 Rust | 📅 2026-08-17 - Build and publish Rust-based Python packages with pyo3, cffi, and uniffi bindings.
...
* [RustPython](https://github.com/RustPython/RustPython) ⭐ 22,297 | 🐛 394 | 🌐 Rust | 📅 2026-08-23 - A Python 3 interpreter written entirely in Rust.
* [PyO3](https://github.com/PyO3/pyo3) ⭐ 16,059 | 🐛 393 | 🌐 Rust | 📅 2026-08-23 - Rust bindings for the Python interpreter. The foundation for most projects on this list.
* [setuptools-rust](https://github.com/PyO3/setuptools-rust) ⭐ 677 | 🐛 16 | 🌐 Python | 📅 2026-08-12 - Setuptools plugin for Rust extensions.

## Scientific Computing

* [river](https://github.com/online-ml/river) ⭐ 5,921 | 🐛 70 | 🌐 Python | 📅 2026-08-21 - Online machine learning in Python; computationally heavy algorithms in Rust.
...
* [PySpector](https://github.com/ParzivalHack/PySpector) ⭐ 150 | 🐛 3 | 🌐 Python | 📅 2026-08-22 - A High-Performance Python/Rust Graph-Based SAST Framework.
...
* [jiter](https://github.com/pydantic/jiter) ⭐ 542 | 🐛 27 | 🌐 Rust | 📅 2026-08-22 - Fast iterable JSON parser, used by pydantic and the OpenAI Python SDK.
...
* [tiktoken](https://github.com/openai/tiktoken) ⭐ 19,068 | 🐛 128 | 🌐 Python | 📅 2026-08-17 - A fast BPE tokenizer for use with OpenAI's models.
* [tokenizers](https://github.com/huggingface/tokenizers) ⭐ 10,985 | 🐛 270 | 🌐 Rust | 📅 2026-08-21 - Hugging Face's fast tokenizer library with Python bindings.
* [safetensors](https://github.com/huggingface/safetensors) ⭐ 3,863 | 🐛 74 | 🌐 Rust | 📅 2026-08-21 - A safe and fast format for storing and loading tensors.
...
* [jsonschema-rs](https://github.com/Stranger6667/jsonschema) ⭐ 805 | 🐛 14 | 🌐 Rust | 📅 2026-08-22 - A high-performance JSON Schema validator.

## Visualization

* [rerun](https://github.com/rerun-io/rerun) ⭐ 11,340 | 🐛 1,272 | 🌐 Rust | 📅 2026-08-21 - Visualize streams of multimodal data. Built in Rust with a Python SDK.
...
* [granian](https://github.com/emmett-framework/granian) ⭐ 5,564 | 🐛 42 | 🌐 Rust | 📅 2026-08-18 - A Rust HTTP server for Python WSGI/ASGI/RSGI apps, built on Hyper and Tokio.
